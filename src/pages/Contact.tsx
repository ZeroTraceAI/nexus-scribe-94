...
const Contact = () => {
  ...
  return (
    <Layout>
      <SEO title="Contact Us" description="Have a question, feedback, or want to collaborate? Get in touch with the CodeSecAI team." canonical="/contact" breadcrumbs={[{ name: "Home", path: "/" }, { name: "Contact", path: "/contact" }]} />
